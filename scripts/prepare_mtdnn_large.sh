...
trained_path="${model_root}/grad/${seed}/${modelname}/train_qqp_lr5e-5/model_4.pt"
mask_percent=`seq 2.5 2.5 100`
model_dir="${model_root}/grad/${seed}/${modelname}/${prefix}"
log_file="${model_dir}/log.log"
python train_rewind.py \
...
trained_path="${model_root}/grad/${seed}/${modelname}/train_qnli_lr5e-5/model_4.pt"
mask_percent=`seq 2.5 2.5 100`
model_dir="${model_root}/grad/${seed}/${modelname}/${prefix}"
log_file="${model_dir}/log.log"
...
trained_path="${model_root}/grad/${seed}/${modelname}/train_sst_lr5e-5/model_3.pt"
mask_percent=`seq 2.5 2.5 100`
model_dir="${model_root}/grad/${seed}/${modelname}/${prefix}"
log_file="${model_dir}/log.log"
...
trained_path="${model_root}/grad/${seed}/${modelname}/train_rte_lr5e-5/model_4.pt"
mask_percent=`seq 2.5 2.5 100`
model_dir="${model_root}/grad/${seed}/${modelname}/${prefix}"
log_file="${model_dir}/log.log"
python train_rewind.py \
