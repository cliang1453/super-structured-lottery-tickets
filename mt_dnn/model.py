...
class MTDNNModel(object):
    ...
    def mask_heads(self, heads_to_mask=None):
        self.network.mask_heads(heads_to_mask)

    def clear_heads(self):
        self.network.clear_heads()

    def mask_ffn(self, ffn_to_mask=None):
        self.network.mask_ffn(ffn_to_mask)

    def clear_ffn(self):
        self.network.clear_ffn()
